    ...
    translations = {
        ...
        "predicted_lddt_head": {
            "input_layer_norm": LayerNormParams(
                model.plddt.layer_norm
            ),
            "act_0": LinearParams(model.plddt.linear_1),
            "act_1": LinearParams(model.plddt.linear_2),
            "logits": LinearParams(model.plddt.linear_3),
        },
        # # "distogram_head": {
        ...
        "experimentally_resolved_head": {
            "logits": LinearParams(
                model.experimentally_resolved.linear
            ),
        },
        # "masked_msa_head": {
...
# import sys
# sys.path.append('../../')
# from model.attentivedist6 import AttentiveDist6
# import argparse
...
# model = AttentiveDist6(args)
# import_jax_weights_(model, '/net/kihara/home/zhan1797/Desktop/alphafold2_embeddings/params/params_model_1.npz')
