...
def compute_renamed_ground_truth2(
    batch: Dict[str, torch.Tensor],
    atom14_pred_positions: torch.Tensor,
    eps=1e-10,
) -> Dict[str, torch.Tensor]:
    ...
    atom14_alt_gt_positions = batch["atom14_alt_gt_positions" + suffix]
    alt_gt_dists = torch.sqrt(
        eps
        + torch.sum(
            (
    ...
    atom14_gt_exists = batch["atom14_gt_exists"+ suffix]
    atom14_atom_is_ambiguous = batch["atom14_atom_is_ambiguous"+ suffix]
    mask = (
        atom14_gt_exists[..., None, :, None]
        * atom14_atom_is_ambiguous[..., None, :, None]
        * atom14_gt_exists[..., None, :, None, :]
